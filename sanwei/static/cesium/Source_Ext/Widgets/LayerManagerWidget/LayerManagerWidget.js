...
(function (Cesium) {
    ...
    var LayerManagerWidget = Cesium.LayerManagerWidget = function (map, options) {
        ...
        if (Cesium.defined(options)) {
            if (Cesium.defined(options.trigDiv)) {
                if ($(options.trigDiv)) {
                    ...
                    this.showLayerManagerWidget(map);
        ...
        /*******节点操作监听开始*******/
        //点击dom后显示图层管理widget
        $(".lm-widget-show").on("click", $.proxy(this.showLayerManagerWidget, this, this.layerManager));
    ...
    function showLayerManagerWidget(map) {
        ...
        var serviceLayerGroup = map.layerManager.getServiceLayerGroup();
